...
-- 19. Calculate the average time between a user's first and most recent post.

-- 20. Identify potential spam accounts (users with high post frequency but low engagement).
